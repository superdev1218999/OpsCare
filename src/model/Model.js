...
class Model {
  ...
  postReq(path, body, callback) {
    ...
    console.log(body);
    axios
    //.post('http://localhost:8019/ah2stagingwebservice' + path, {username: body.username, password: body.password}, {
    .post(this.apiEndPoint + path, {username: body.username, password: body.password}, {
        headers: {
          "Content-Type": "application/json",
          Authorization: AuthStr,
        },
